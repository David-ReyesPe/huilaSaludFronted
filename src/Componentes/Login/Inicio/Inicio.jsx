...
export function Inicio() {
  return (
    <div className="w-full h-full md:h-[700px] bg-[url('C:\Users\drako\OneDrive\Documentos\Proyectos\HUILA-SALUD\huilaSalud\src\assets\Images\indexResponsive.png')] md:bg-[url('C:\Users\drako\OneDrive\Documentos\Proyectos\HUILA-SALUD\huilaSalud\src\assets\Images\index.png')] ">
      <div className="flex justify-center place-items-center p-10 gap-24 h-[700px]">
        <div className="w-full max-w-md max-h-md">
          <form className="bg-white shadow-md rounded border-2 px-8 pt-6 pb-8 h-500 w-full ">
            <div className="mb-4">
              <label
            ...
            <div className="flex items-center justify-between">
              ...
              <a
                className="inline-block align-baseline font-bold text-sm text-[#053B50] hover:text-[#092530]"
                href="#"
              >
                Forgot Password?
              </a>
